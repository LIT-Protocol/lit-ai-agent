...
export interface SwapPolicy {
  maxAmount: string; // uint256 as string (e.g., "1000000000000000000")
  allowedTokens: string[]; // array of token addresses
}
 ...
 */
export function encodeSwapPolicy(policy: SwapPolicy): string {
